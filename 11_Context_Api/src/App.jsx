  ...
  return (
    <>
      ...
      {isCartOpen ? (
        ...
        <main className="min-h-screen bg-gradient-to-br from-slate-50 via-violet-50 to-purple-100 pt-32 pb-16">
          <div className="mx-auto max-w-7xl px-6">
            ...
            <div className="mb-16 text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-500">
                Carefully selected products with modern design and premium
                quality.
              </p>
            </div>
